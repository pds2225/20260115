...
FitScore 100점 만점 계산:
  - base_score(50) + hs_match(20) + price(15) + moq(10) + cert(15)
  - fraud_penalty(-25) + success_bonus(0~20)

Hard Gate:
  - MOQ 불일치 (buyer_moq < seller_moq * 0.3) -> 즉시 탈락
  - 필수 인증 미충족 -> 즉시 탈락

참조: docs/RULES_SPEC.md, notebookLM 분석결과
"""
...
from backend.data.sanctions import check_compliance, SanctionStatus
